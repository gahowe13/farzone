...
class BootScene extends Scene {
  ...
  preload() {
    ...
    this.load.multiatlas(
      "mech1",
      "assets/sprites/mech1.json",
      "assets/sprites"
    );
    this.load.multiatlas(
      "mech1-arm-left",
      "assets/sprites/mech1-left-arm.json",
      "assets/sprites"
    );
    this.load.multiatlas(
      "mech1-arm-right",
      "assets/sprites/mech1-right-arm.json",
      "assets/sprites"
    );
    this.load.image("l-mech1-head", [
      "assets/sprites/l-mech1-head.png",
      "assets/sprites/l-mech1-head_n.png",
    ]);
    this.load.image("r-mech1-head", [
      "assets/sprites/r-mech1-head.png",
      "assets/sprites/r-mech1-head_n.png",
    ]);
    this.load.image("mech1-shell", "assets/sprites/mech1-shell.png");
    this.load.image("mech1-victory", "assets/sprites/mech1-victory.png");
    this.load.image("bullet", "assets/sprites/mech1-bullet.png");

    // Hume1
    this.load.multiatlas(
      "hume1",
      "assets/sprites/hume1.json",
      "assets/sprites"
    );
    this.load.image("hume1-head", [
      "assets/sprites/hume1-head.png",
      "assets/sprites/hume1-head_n.png",
    ]);
    this.load.image("hume1-sword-arm", [
      "assets/sprites/hume1-sword-arm-aim.png",
      "assets/sprites/hume1-sword-arm-aim_n.png",
    ]);
    this.load.image("hume1-shield-arm", [
      "assets/sprites/hume1-shield-arm-aim.png",
      "assets/sprites/hume1-shield-arm-aim_n.png",
    ]);
    ...
    // Maps 2.0
    this.load.image("tileset-ex", [
      "assets/maps/2.0/tileset-ex.png",
      "assets/maps/2.0/tileset-ex_n.png",
    ]);
    this.load.tilemapTiledJSON("map1", "assets/maps/2.0/map1.json");
    this.load.tilemapTiledJSON(
      "map2-the-spire",
      "assets/maps/2.0/the-spire.json"
    );
    this.load.tilemapTiledJSON(
      "map2-the-great-wall",
      "assets/maps/2.0/the-great-wall.json"
    );
    ...
    this.load.audio(
      "mitch-this-games-winner-is",
      "assets/sfx/mitch/this-games-winner-is.mp3"
    );

    // VFX
    this.load.spritesheet(
      "particles-dirt",
      "assets/sprites/particles-dirt.png",
      { frameWidth: 192, frameHeight: 228 }
    );
    this.load.spritesheet(
      "particles-grass",
      "assets/sprites/particles-grass.png",
      { frameWidth: 45, frameHeight: 157 }
    );
    this.load.image("particle-fire", "assets/particles/fire.png");
    this.load.image("particle-explosion", "assets/particles/explosion.png");
    this.load.spritesheet("particles-brick", "assets/particles/brick.png", {
      frameWidth: 205,
      frameHeight: 78,
    });
    this.load.spritesheet(
      "particles-wood",
      "assets/particles/wood-splinters.png",
      { frameWidth: 24, frameHeight: 243 }
    );
    this.load.spritesheet("particles-leaves", "assets/particles/leaves.png", {
      frameWidth: 111,
      frameHeight: 281,
    });
    ...
    this.preloaderLog = this.add.text(
  ...
  create() {
    ...
    this.anims.create({
      key: "hume1-aim",
      frames: [{ key: "hume1", frame: "aim.png" }],
      frameRate: 0,
      repeat: 0,
    });
